...
- Here $z^*$ is the critical value from the normal distribution that matches your desired confidence level. For 95% confidence, $z^* = 1.96$. For 99% confidence, $z^* = 2.576$.
